...
function buildDrivers(summary: TodaySummary): DriverSpec[] {
  ...
  return [
    ...
    {
      label: "Hydration",
      value: componentScore("hydration"),
      hint: "self-reported",
      tone: toneFromScore(componentScore("hydration")),
      icon: Droplet,
    },
    {
      label: "Soreness",
    ...
    {
      label: "Mobility",
      value: componentScore("mobility"),
      hint: "relative",
      tone: toneFromScore(componentScore("mobility")),
      icon: Activity,
    },
    {
      label: "Training Load",
      value: componentScore("load"),
      hint: "7d ratio",
      tone: toneFromScore(componentScore("load")),
      icon: Dumbbell,
    },
  ];
}
